...
const array = ['amaru','annaa','babysong','bgm21','cyberbanner','Cyberbanner1','cybersmokey','I love u','kachabadam','kannaappy','lalettan','macha','maranam','mine','mood on','nanbaaa','podaa','RIP','saji','sarasu','uyire','moodesh','angene','beauty queen','bestie','bike','blackpink','bot','cr','exam','fight','football','friend','hacker','help','i love u','kozhi','Mishal','pani','peace','pever','poda','Richu','sad','sed','tentacion','thep','va','yadu','xxx','Bot','richu','bgm1','bgm2','bgm3','bgm4','bgm5','bgm6','bgm7','bgm8','bgm9','bgm10','bgm11','bgm12','bgm13','bgm14','bgm15','sad','scene','sed','she','ra','mu','hot','ta','Cr7','uyir','power','va','wow','se','no','nanba','sebin','messi','maman','pha','oi','cha','muth','kiss','dey','ga','player','king','kayari','aliya','nari','omban','Hii','Da','sad','nee','myre','mood','bg','chunk','ser','kundan','sir','My','myr','umbi','bot','poda','git','alive','owner','neymar','list','oii','on','one','vanne','vannu','set','Fuck','love','broke','ohoo','Bye','pne','left','don','onn','stop','setta','entry','muth','Hi','chaya']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
